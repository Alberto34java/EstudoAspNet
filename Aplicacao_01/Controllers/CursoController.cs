...
namespace Aplicacao_01.Controllers
{
    public class CursoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Duracao,TipoFormacao")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Duracao,TipoFormacao")] Curso curso)
        {
            if (id != curso.Id)
            {
                return NotFound();
